...
// defines a Store struct and a function called NewStore for creating instances of this struct.
...
// TransferTx performs a money transfer trom one account to the other
